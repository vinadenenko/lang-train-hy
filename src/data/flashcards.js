...
// Card structure:
// { id, cat, hy, translit, translations: { en, ru }, example, exampleTranslit, examples: { en, ru } }
export const FLASHCARDS = [
  // ── Greetings & Politeness ──────────────────────────────────────────
  { id: 'g01', cat: 'greetings', hy: 'Բարև',             translit: 'Barev',
    translations: { en: 'Hello',                    ru: 'Привет' },
    example: 'Բարև, ինչպե՞ս ես։',                  exampleTranslit: "Barev, inch'pes yes?",
  ...
  { id: 'g02', cat: 'greetings', hy: 'Բարև Ձեզ',         translit: 'Barev Dzez',
    ...
    example: 'Բարև Ձեզ, պ՛արոն։',                  exampleTranslit: "Barev Dzez, p'aron.",
  ...
  { id: 'g03', cat: 'greetings', hy: 'Ողջույն',           translit: 'Voghchuyn',
    ...
    example: 'Ողջույն բոլորին։',                    exampleTranslit: 'Voghchuyn bolorin.',
  ...
  { id: 'g04', cat: 'greetings', hy: 'Ցտեսություն',       translit: "Ts'tesut'yun",
    ...
    example: 'Ցտեսություն, մինչ վաղը։',              exampleTranslit: "Ts'tesut'yun, minch' vaghn.",
  ...
  { id: 'g05', cat: 'greetings', hy: 'Շնորհակալություն', translit: "Shnorhakal'ut'yun",
    ...
    example: 'Շնորհակալություն օգնության համար։',    exampleTranslit: "Shnorhakal'ut'yun vognut'yan hamar.",
  ...
  { id: 'g06', cat: 'greetings', hy: 'Խնդրեմ',           translit: 'Khndrem',
    ...
    example: 'Խնդրեմ, նստե՛ք։',                    exampleTranslit: "Khndrem, nstek'.",
  ...
  { id: 'g07', cat: 'greetings', hy: 'Կներեք',           translit: "Knerek'",
    ...
    example: 'Կներեք, որտե՞ղ է կայարանը։',          exampleTranslit: "Knerek', vort'egh e kayarany?",
  ...
  { id: 'g08', cat: 'greetings', hy: 'Այո',              translit: 'Ayo',
    ...
    example: 'Այո, ճիշտ է։',                        exampleTranslit: 'Ayo, chisht e.',
    examples:    { en: 'Yes, that is correct.',      ru: 'Да, это верно.' } },

  { id: 'g09', cat: 'greetings', hy: 'Ոչ',              translit: "Voch'",
    translations: { en: 'No',                        ru: 'Нет' },
    example: 'Ոչ, ես չգիտեմ։',                     exampleTranslit: "Voch', yes ch'gitem.",
    examples:    { en: 'No, I do not know.',         ru: 'Нет, я не знаю.' } },

  { id: 'g10', cat: 'greetings', hy: 'Ինչպե՞ս ես',      translit: "Inch'pes yes",
    translations: { en: 'How are you?',              ru: 'Как дела?' },
    example: 'Ինչպե՞ս ես, ընկե՛ր։',                exampleTranslit: "Inch'pes yes, ynk'er?",
  ...
  { id: 'g11', cat: 'greetings', hy: 'Լավ եմ',          translit: 'Lav em',
    ...
    example: 'Շնորհակալություն, լավ եմ։',            exampleTranslit: "Shnorhakal'ut'yun, lav em.",
  ...
  { id: 'g12', cat: 'greetings', hy: 'Բարի գալուստ',   translit: 'Bari galust',
    ...
    example: 'Բարի գալուստ Հայաստան։',              exampleTranslit: 'Bari galust Hayastan.',
  ...
  { id: 'g13', cat: 'greetings', hy: 'Բարի գիշեր',     translit: 'Bari gisher',
    ...
    example: 'Բարի գիշեր, հանգիստ քուն։',          exampleTranslit: "Bari gisher, hangist k'un.",
  ...
  { id: 'g14', cat: 'greetings', hy: 'Բարի լույս',      translit: 'Bari luys',
    ...
    example: 'Բարի լույս, ե՛ս եմ։',                exampleTranslit: 'Bari luys, yes em.',
  ...
  { id: 'g15', cat: 'greetings', hy: 'Ներողություն',    translit: "Neroghut'yun",
    ...
    example: 'Ներողություն կխնդրեմ։',               exampleTranslit: "Neroghut'yun kkhndrem.",
  ...
  { id: 'n04', cat: 'numbers', hy: 'Երեք',   translit: "Yerek'",
    ...
    example: 'Երեք օր անց եմ գնում։',        exampleTranslit: "Yerek' or ants' em gnum.",
  ...
  { id: 'n05', cat: 'numbers', hy: 'Չորս',   translit: "Ch'ors",
    ...
    example: 'Ձմեռն ունի չորս ամիս։',        exampleTranslit: "Dzmern uni ch'ors amis.",
  ...
  { id: 'n06', cat: 'numbers', hy: 'Հինգ',   translit: 'Hing',
    ...
    example: 'Հինգ րոպե կսպասեմ։',           exampleTranslit: 'Hing rope kspasem.',
  ...
  { id: 'n09', cat: 'numbers', hy: 'Ութ',    translit: "Ut'",
    ...
    example: 'Ութ ժամ աշխատեցի։',            exampleTranslit: "Ut' zham ashkhatets'i.",
  ...
  { id: 'n10', cat: 'numbers', hy: 'Ինը',    translit: 'Iny',
    ...
    example: 'Ինը հոգի կա սրճարանում։',      exampleTranslit: 'Iny hogi ka srcharanum.',
  ...
  { id: 'n11', cat: 'numbers', hy: 'Տաս',    translit: 'Tas',
    ...
    example: 'Տաս րոպե հետո գամ։',           exampleTranslit: 'Tas rope heto gam.',
  ...
  { id: 'n12', cat: 'numbers', hy: 'Քսան',   translit: "K'san",
    ...
    example: 'Ես քսան տարեկան եմ։',          exampleTranslit: "Yes k'san tarekan em.",
  ...
  { id: 'n13', cat: 'numbers', hy: 'Հարյուր', translit: 'Haryur',
    ...
    example: 'Հարյուր դրամ ունեմ։',          exampleTranslit: 'Haryur dram unem.',
  ...
  { id: 'n14', cat: 'numbers', hy: 'Հազար',  translit: 'Hazar',
    ...
    example: 'Մեկ հազար մետր բարձրություն։', exampleTranslit: "Mek hazar metr bardzrut'yun.",
  ...
  { id: 'n15', cat: 'numbers', hy: 'Առաջին', translit: 'Arajin',
    ...
    example: 'Առաջին հարկ, խնդրեմ։',         exampleTranslit: 'Arajin hark, khndrem.',
  ...
  { id: 'c01', cat: 'colors', hy: 'Կարմիր',         translit: 'Karmir',
    ...
    example: 'Վարդը կարմիր է։',               exampleTranslit: 'Vardy karmir e.',
    examples:    { en: 'The rose is red.',              ru: 'Роза красная.' } },

  { id: 'c02', cat: 'colors', hy: 'Կանաչ',          translit: "Kanach'",
    translations: { en: 'Green',   ru: 'Зелёный' },
    example: 'Ծառերը կանաչ են գարնանը։',      exampleTranslit: "Tsarrely kanach' en garnany.",
  ...
  { id: 'c07', cat: 'colors', hy: 'Նարնջագույն',    translit: 'Narnjagoyn',
    ...
    example: 'Նարինջը նարնջագույն է։',        exampleTranslit: 'Narinjy narnjagoyn e.',
  ...
  { id: 'c08', cat: 'colors', hy: 'Մանուշակագույն', translit: 'Manushakagoyn',
    ...
    example: 'Ծաղիկը մանուշակագույն է։',      exampleTranslit: 'Tsaghiky manushakagoyn e.',
  ...
  { id: 'c09', cat: 'colors', hy: 'Վարդագույն',     translit: 'Vardagoyn',
    ...
    example: 'Շապիկը վարդագույն է։',          exampleTranslit: 'Shapiky vardagoyn e.',
  ...
  { id: 'f03', cat: 'family', hy: 'Եղբայր', translit: 'Yeghbayr',
    ...
    example: 'Ես ունեմ երկու եղբայր։',        exampleTranslit: 'Yes unem yerku yeghbayr.',
  ...
  { id: 'f04', cat: 'family', hy: 'Քույր',   translit: "K'uyr",
    ...
    example: 'Քույրս Երևանում է ապրում։',     exampleTranslit: "K'uyrs Yerevanum e aprum.",
  ...
  { id: 'f05', cat: 'family', hy: 'Տատ',     translit: 'Tat',
    ...
    example: 'Տատս լավ է եփում։',             exampleTranslit: "Tats lav e yep'um.",
  ...
  { id: 'f06', cat: 'family', hy: 'Պապ',     translit: 'Pap',
    ...
    example: 'Պապս 80 տարեկան է։',            exampleTranslit: 'Paps 80 tarekan e.',
  ...
  { id: 'f07', cat: 'family', hy: 'Որդի',    translit: 'Vordi',
    ...
    example: 'Իմ որդին 5 տարեկան է։',         exampleTranslit: 'Im vordin 5 tarekan e.',
  ...
  { id: 'f08', cat: 'family', hy: 'Դուստր',  translit: 'Dustr',
    ...
    example: 'Դուստրս դպրոց է գնում։',        exampleTranslit: "Dustrs dprots' e gnum.",
  ...
  { id: 'f09', cat: 'family', hy: 'Ամուսին', translit: 'Amusin',
    ...
    example: 'Ամուսինս աշխատում է։',           exampleTranslit: 'Amusins ashkhatum e.',
  ...
  { id: 'f10', cat: 'family', hy: 'Կին',     translit: 'Kin',
    ...
    example: 'Կինս ուրախ է։',                 exampleTranslit: 'Kins urakh e.',
  ...
  { id: 'f11', cat: 'family', hy: 'Ընկեր',   translit: "Ynk'er",
    ...
    example: 'Նա իմ լավ ընկերն է։',           exampleTranslit: "Na im lav ynk'ern e.",
  ...
  { id: 'fd04', cat: 'food', hy: 'Թեյ',        translit: "T'ey",
    ...
    example: 'Ես թեյ եմ սիրում։',             exampleTranslit: "Yes t'ey em sirum.",
    examples:    { en: 'I like tea.',                   ru: 'Я люблю чай.' } },

  { id: 'fd05', cat: 'food', hy: 'Միս',        translit: 'Mis',
    translations: { en: 'Meat',               ru: 'Мясо' },
    example: 'Ես շատ միս չեմ ուտում։',         exampleTranslit: "Yes shat mis ch'em utum.",
  ...
  { id: 'fd06', cat: 'food', hy: 'Ձուկ',       translit: 'Dzuk',
    ...
    example: 'Ձուկը թարմ է։',                 exampleTranslit: "Dzuky t'arm e.",
  ...
  { id: 'fd07', cat: 'food', hy: 'Բանջարեղեն', translit: 'Banjareghen',
    ...
    example: 'Բանջարեղենն օգտակար է։',        exampleTranslit: 'Banjareghen vogtakar e.',
  ...
  { id: 'fd08', cat: 'food', hy: 'Մրգեր',      translit: 'Mrger',
    ...
    example: 'Ես մրգեր եմ սիրում։',           exampleTranslit: 'Yes mrger em sirum.',
    examples:    { en: 'I like fruits.',                ru: 'Я люблю фрукты.' } },

  { id: 'fd09', cat: 'food', hy: 'Պանիր',      translit: 'Panir',
    translations: { en: 'Cheese',             ru: 'Сыр' },
    example: 'Հայկական պանիրը համեղ է։',       exampleTranslit: 'Haykakan paniry hamegh e.',
  ...
  { id: 'fd10', cat: 'food', hy: 'Կաթ',        translit: "Kat'",
    ...
    example: 'Ես ամեն օր կաթ եմ խմում։',       exampleTranslit: "Yes amen or kat' em khmum.",
  ...
  { id: 'fd11', cat: 'food', hy: 'Ձու',        translit: 'Dzu',
    ...
    example: 'Ձուն ամուր եփված է։',            exampleTranslit: "Dzun amur yep'vats e.",
  ...
  { id: 'fd12', cat: 'food', hy: 'Թթու',       translit: "T't'u",
    ...
    example: 'Թթուն շատ թթու է։',             exampleTranslit: "T't'un shat t't'u e.",
  ...
  { id: 'fd13', cat: 'food', hy: 'Մածուն',     translit: "Mats'un",
    ...
    example: 'Մածունն Հայաստանում ազգային ուտեստ է։', exampleTranslit: "Mats'unn Hayastanum azgayin utest e.",
  ...
  { id: 'fd14', cat: 'food', hy: 'Խաշ',        translit: 'Khash',
    ...
    example: 'Խաշ ենք ուտում ձմռանը։',         exampleTranslit: "Khash yenk' utum dzmrrany.",
  ...
  { id: 'fd15', cat: 'food', hy: 'Գինի',       translit: 'Gini',
    ...
    example: 'Հայկական գինին հայտնի է։',       exampleTranslit: 'Haykakan ginin haytni e.',
  ...
  { id: 'p01', cat: 'phrases', hy: 'Ես չեմ հասկանում',        translit: "Yes ch'em haskanum",
    ...
    example: 'Կներեք, ես չեմ հասկանում։',         exampleTranslit: "Knerek', yes ch'em haskanum.",
  ...
  { id: 'p02', cat: 'phrases', hy: 'Կրկնե՛ք',                 translit: "Krknek'",
    ...
    example: 'Կրկնե՛ք, խնդրեմ։',                 exampleTranslit: "Krknek', khndrem.",
  ...
  { id: 'p03', cat: 'phrases', hy: 'Դուք խոսու՞մ եք հայերեն', translit: "Duk' khossum ek' hayeren",
    ...
    example: 'Դուք խոսու՞մ եք հայերեն, թե անգլերեն։', exampleTranslit: "Duk' khossum ek' hayeren, t'e angleren?",
  ...
  { id: 'p04', cat: 'phrases', hy: 'Ես հայերեն եմ սովորում',  translit: 'Yes hayeren em sovorvum',
    ...
    example: 'Ես հայերեն եմ սովորում դպրոցում։',  exampleTranslit: "Yes hayeren em sovorvum dprots'um.",
  ...
  { id: 'p10', cat: 'phrases', hy: 'Ի՞նչ արժե',               translit: "Inch' arzhe",
    ...
    example: 'Ի՞նչ արժե սա։',                      exampleTranslit: "Inch' arzhe sa?",
  ...
  { id: 'p11', cat: 'phrases', hy: 'Ես սիրում եմ',            translit: 'Yes sirum em',
    ...
    example: 'Ես սիրում եմ Հայաստանը։',            exampleTranslit: 'Yes sirum em Hayastany.',
  ...
  { id: 'p12', cat: 'phrases', hy: 'Ես ուզում եմ',            translit: 'Yes uzum em',
    ...
    example: 'Ես ուզում եմ ուտել։',                exampleTranslit: 'Yes uzum em utel.',
    examples:    { en: 'I want to eat.',            ru: 'Я хочу есть.' } },

  // ── Time & Days ──────────────────────────────────────────────────────
  { id: 't01', cat: 'time', hy: 'Այսօր',      translit: 'Aysor',
    translations: { en: 'Today',     ru: 'Сегодня' },
    example: 'Այսօր եղանակը լավ է։',           exampleTranslit: 'Aysor yeghonaky lav e.',
  ...
  { id: 't02', cat: 'time', hy: 'Վաղը',       translit: 'Vaghn',
    ...
    example: 'Վաղը կգամ։',                     exampleTranslit: 'Vaghn kgam.',
  ...
  { id: 't07', cat: 'time', hy: 'Օր',         translit: 'Or',
    ...
    example: 'Ամեն օր ես սովորում եմ։',         exampleTranslit: 'Amen or yes sovorvum em.',
  ...
  { id: 't08', cat: 'time', hy: 'Շաբաթ',      translit: "Shabat'",
    ...
    example: 'Մեկ շաբաթ հետո կտեսնվենք։',      exampleTranslit: "Mek shabat' heto ktesnvenk'.",
  ...
  { id: 't09', cat: 'time', hy: 'Ամիս',       translit: 'Amis',
    ...
    example: 'Ես մեկ ամիս Երևանում էի։',        exampleTranslit: 'Yes mek amis Yerevanum eyi.',
  ...
  { id: 't10', cat: 'time', hy: 'Տարի',       translit: 'Tari',
    ...
    example: 'Անցած տարի լավ էր։',              exampleTranslit: "Ants'ats tari lav er.",
  ...
  { id: 't11', cat: 'time', hy: 'Երկուշաբթի', translit: 'Yerkushabti',
    ...
    example: 'Երկուշաբթին նոր սկիզբ է։',        exampleTranslit: 'Yerkushabthin nor skizb e.',
  ...
  { id: 't12', cat: 'time', hy: 'Ուրբաթ',     translit: "Urbat'",
    ...
    example: 'Ուրբաթն իմ սիրած օրն է։',         exampleTranslit: "Urbat'n im sirats' orn e.",
  ...
  { id: 't13', cat: 'time', hy: 'Կիրակի',     translit: 'Kiraki',
    ...
    example: 'Կիրակի հանգստի օր է։',            exampleTranslit: 'Kiraki hangsti or e.',
  ...
  { id: 'v01', cat: 'verbs', hy: 'Գնալ',   translit: 'Gnal',
    ...
    example: 'Ես ուզում եմ գնալ տուն։',     exampleTranslit: 'Yes uzum em gnal tun.',
  ...
  { id: 'v05', cat: 'verbs', hy: 'Խոսել',  translit: 'Khosel',
    ...
    example: 'Ես հայերեն եմ խոսում։',       exampleTranslit: 'Yes hayeren em khosum.',
  ...
  { id: 'v08', cat: 'verbs', hy: 'Կարդալ', translit: 'Kardal',
    ...
    example: 'Ես գիրք եմ կարդում։',          exampleTranslit: "Yes girk' em kardum.",
    examples:    { en: 'I am reading a book.',          ru: 'Я читаю книгу.' } },

  { id: 'v09', cat: 'verbs', hy: 'Գրել',   translit: 'Grel',
    translations: { en: 'To write',         ru: 'Писать' },
    example: 'Ես նամակ եմ գրում։',           exampleTranslit: 'Yes namak em grum.',
  ...
  { id: 'v11', cat: 'verbs', hy: 'Աշխատել', translit: 'Ashkhatel',
    ...
    example: 'Ես ամեն օր աշխատում եմ։',      exampleTranslit: 'Yes amen or ashkhatum em.',
  ...
  { id: 'v12', cat: 'verbs', hy: 'Քնել',   translit: "K'nel",
    ...
    example: 'Ես ուշ եմ քնել ուզում։',       exampleTranslit: "Yes ush em k'nel uzum.",
  ...
  { id: 'a01', cat: 'adjectives', hy: 'Մեծ',      translit: 'Mets',
    ...
    example: 'Երևանը մեծ քաղաք է։',          exampleTranslit: "Yerevany mets k'aghak' e.",
  ...
  { id: 'a02', cat: 'adjectives', hy: 'Փոքր',     translit: "P'ok'r",
    ...
    example: 'Սա փոքր տուն է։',              exampleTranslit: "Sa p'ok'r tun e.",
  ...
  { id: 'a03', cat: 'adjectives', hy: 'Լավ',      translit: 'Lav',
    ...
    example: 'Դա լավ գաղափար է։',            exampleTranslit: 'Da lav gaghapar e.',
  ...
  { id: 'a04', cat: 'adjectives', hy: 'Վատ',      translit: 'Vat',
    ...
    example: 'Եղանակը վատ է այսօր։',          exampleTranslit: 'Yeghonaky vat e aysor.',
  ...
  { id: 'a05', cat: 'adjectives', hy: 'Շատ',      translit: 'Shat',
    ...
    example: 'Շատ շնորհակալություն։',         exampleTranslit: "Shat shnorhakal'ut'yun.",
  ...
  { id: 'a06', cat: 'adjectives', hy: 'Քիչ',      translit: "K'ich'",
    ...
    example: 'Ես քիչ-քիչ հայերեն գիտեմ։',    exampleTranslit: "Yes k'ich'-k'ich' hayeren gitem.",
  ...
  { id: 'a07', cat: 'adjectives', hy: 'Նոր',      translit: 'Nor',
    ...
    example: 'Ունեմ նոր հեռախոս։',           exampleTranslit: 'Unem nor herrakhos.',
  ...
  { id: 'a08', cat: 'adjectives', hy: 'Հին',      translit: 'Hin',
    ...
    example: 'Սա հին եկեղեցի է։',            exampleTranslit: 'Sa hin yekeghetsi e.',
  ...
  { id: 'a09', cat: 'adjectives', hy: 'Գեղեցիկ', translit: "Geghetsi k'",
    ...
    example: 'Հայաստանը շատ գեղեցիկ է։',    exampleTranslit: "Hayastany shat geghetsi k' e.",
  ...
  { id: 'a10', cat: 'adjectives', hy: 'Ուժեղ',    translit: 'Uzhegh',
    ...
    example: 'Նա ուժեղ մարդ է։',             exampleTranslit: 'Na uzhegh mard e.',
  ...
  { id: 'a11', cat: 'adjectives', hy: 'Հեշտ',     translit: 'Hesht',
    ...
    example: 'Հայերենը հեշտ չէ, բայց հնարավոր է։', exampleTranslit: "Hayereny hesht ch'e, bayts' hnaravor e.",
  ...
  { id: 'a12', cat: 'adjectives', hy: 'Դժվար',    translit: 'Dzhvar',
    ...
    example: 'Սա դժվար հարց է։',             exampleTranslit: "Sa dzhvar harts' e.",
